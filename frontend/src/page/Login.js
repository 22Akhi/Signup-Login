...
<img src={ loginSignupImage} className = "w-full"/>
    ...
    <button  className = "w-full max-w-[150px] m-auto w-full bg-red-500 hover:bg-red-600 cursor-pointer text-white text-xl font-medium text-center py-1 rounded-full mt-4 ">Login</button>
    </form>
